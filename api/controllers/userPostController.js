...
const updateUserPost = async (req, res, next) => {
    try {
        const updatedUserPost = await UserPost.findByIdAndUpdate(req.params.id, { $set: req.body }, { new: true })
...
//export
module.exports = { createUserPost, updateUserPost, getUserPost, getAllUserPosts, deleteUserPost }